 ...
 */
export default class KingmakerKingdomLayer extends PIXI.Container {
  constructor() {
    super();
    this.zIndex = 1;
    this.visible = false;
  ...
  draw() {
    ...
    const hexes = kingmaker.region.hexes.filter(h => h.data.claimed);
    const polygons = KingmakerKingdomLayer.#buildPolygons(hexes);
